 ...
 class ProductForm extends Form
 {
    ...
    public function __construct(AdapterInterface $dbAdapter, $name = null)
    {
		...
		$this->add(array(
            ...
            'options' => array(
                'label' => 'Giới hạn IP truy cập ( Để trống nếu không giới hạn. Các IP cách nhau bởi dấu | )',
                'label_attributes' => array(
                   'for' => '',
                   'class' => 'col-sm-9 controll-label',
                ),
		...
		$this->add(array(
            ...
            'options' => array(
                'label' => 'URL game (  Để trống nếu không điều hướng tới đường dẫn bên ngoài hệ thống)',
                'label_attributes' => array(
                   'for' => '',
                   'class' => 'col-sm-9 controll-label',
                ),
